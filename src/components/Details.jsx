            ...
            <div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="flex flex-col space-y-4">
                    <div>
                        ...
                        <span className="text-sm dark:text-gray-400">{emailVerified ? 'Email Is Verified' : 'Email Not Verified'}</span>
                    </div>
                    <div className="space-y-1">
                        ...
                        <span className="flex items-center space-x-2">
                            ...
                            <span className="dark:text-gray-400">{phoneNumber ? phoneNumber : 'Not Available'}</span>
                        </span>
                    </div>
                </div>
            </div>
